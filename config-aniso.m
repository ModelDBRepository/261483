...
spectacles_l = 0;                                % lense in front of left eye which leads lense to focus at different position plane when relaxed
spectacles_r = 3;                                % lense in front of right eye which leads lense to focus at different position plane when relaxed
...
max_obj_plane = 3;                               % target plane positioned between +-max_obj_plane
max_acc_disp_plane = 3;                          % acc and disp plane between +- max_acc_disp_plane
